...
<body class="bg-gray-100 min-h-screen flex flex-col items-center justify-center p-4">
  <div class="bg-white shadow-lg rounded-lg p-6 w-full max-w-lg text-center">
    ...
    <div class="flex justify-center gap-4 mb-4">
      <button id="cameraButton" class="bg-green-600 hover:bg-green-700 text-white px-4 py-2 rounded">📷 Take Photo</button>
      <button id="chooseButton" class="bg-blue-600 hover:bg-blue-700 text-white px-4 py-2 rounded">📁 Choose File</button>
    </div>
  ...
  <script>
    ...
    solveButton.addEventListener('click', async () => {
      ...
      resultDiv.innerHTML = "⏳ Analyzing question, please wait...";
